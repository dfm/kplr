...
epic_adapter = Adapter({
    ...
    "TYC": ("tyc", unicode),
    "UCAC": ("ucac", unicode),
    "2MASS": ("twomass", unicode),
    "SDSS": ("sdss", unicode),
    "Object type": ("objtype", unicode),
    "Kepflag": ("kepflag", unicode),
    "pmra": ("pmra", float),
    "e_pmra": ("e_pmra", float),
    "pmdec": ("pmdec", float),
    ...
    "e_d": ("e_d", float),
    "E(B-V)": ("ebv", float),
    "2MASS Flag": ("mflg", unicode),
    "Nearest Neighbor": ("prox", float),
    "Nomad ID": ("nomad", unicode),
})
...
k2_dataset_adapter = Adapter({
    ...
    "KEP Mag": ("kp", float),
    "Kep Flag": ("kepflag", unicode),
    "Hip ID": ("hip", int),
    "Tyc ID": ("tyc", unicode),
    "SDSS ID": ("sdss", unicode),
    "UCAC ID": ("ucac", unicode),
    "2MASS ID": ("twoMass", unicode),
    "2MASS Flag": ("mflg", unicode),
